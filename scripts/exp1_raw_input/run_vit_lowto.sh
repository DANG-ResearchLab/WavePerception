...
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/mridata/mahamm2/swh_estimation/experiments/28_May_lowto_experiments_v1/logs/lowto_vit_%j.out
#SBATCH --error=/mnt/mridata/mahamm2/swh_estimation/experiments/28_May_lowto_experiments_v1/logs/lowto_vit_%j.err
...
CONFIG_PATH="$PROJECT_ROOT/configs/lowto_vit.yaml"
...
# ========================================================================
echo "=========================================="
echo "LOWTO Vanilla ViT JOB START"
echo "=========================================="
echo "Date:         $(date)"
echo "Host:         $(hostname)"
...
# ========================================================================
echo "=========================================="
echo "START LOWTO Vanilla ViT"
echo "=========================================="

python -u "$MAIN_SCRIPT" --config "$CONFIG_PATH"

echo "=========================================="
echo "LOWTO Vanilla ViT DONE"
echo "Date: $(date)"
echo "=========================================="
